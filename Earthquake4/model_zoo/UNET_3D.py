...
class unet3d(nn.Module):
    def __init__(self, in_dim, out_dim, num_filters):
        ...
        # Output
        self.out = conv_block_3d(self.num_filters, out_dim, nn.Sigmoid())
...
#
#    model = unet3d(in_dim=3, out_dim=3, num_filters=4)
...
# device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
# unet3d = UNet(1,1,96).to(device)
# summary(unet3d, (1, 96, 96, 96))
